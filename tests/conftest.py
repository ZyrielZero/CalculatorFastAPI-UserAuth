...
def fastapi_server():
    ...
    """
    # Start FastAPI app
    # sys.executable is the interpreter running pytest, so the spawned server
    # always shares the same environment instead of whatever 'python' resolves
    # to on PATH (which can point outside the venv).
