...
import logging  # Standard library logging for tracing operations and errors
from typing import Union  # Import Union for type hinting multiple possible types

# Module-level logger; inherits the root configuration set up in main.py,
# so no basicConfig call is needed (or wanted) here.
...
def divide(a: Number, b: Number) -> float:
    ...
    if b == 0:
        ...
        logger.error("divide(%s, %s) rejected: division by zero", a, b)
